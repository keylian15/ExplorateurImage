...
![Fonction Get du fichier service/thumbnail_cache.py](../Images/code/thumbnail_cache_f_get.png)
...
![Fonction get description and keywords from image de services/ollama_wrapper.py](../Images/code/ollama_wrapper_f_get_description_and_keyword_from_image.png)

![Fonction on signal image done de viewmodels/autocomplete_vm.py ](../Images/code/autocomplete_vm_f_on_signal_image_done.png)
...
![Fonction compute neighbors de viewmodels/detail_vm.py](../Images/code/detail_vm_f_compute_neighbors.png)
...
![Fonction filtered images de viewmodels/gallery_vm.py](../Images/code/gallery_vm_f_filtered_images.png)
...
![Class SearchNode de models/tree/search_node.py](../Images/code/searchnode_c.png)


![Fonction do search de viewmodels/gallery_vm.py](../Images/code/gallery_vm_f_do_search.png)
...
![Fonction compute de services/workers.py](../Images/code/worker_f_compute.png)

![Fonction name cluster async de services/workers.py](../Images/code/worker_f_name_cluster_async.png)
...
![Fonction search de la classe EmbeddingBoxSearch deservices/box_search_strategies.py](../Images/code/embeddingboxsearch_f_search.png)
...
![Fonction search de la classe Sam3BoxSearch de services/box_search_strategies.py](../Images/code/Sam3BoxSearch_f_search.png)
...
![Fonction search de la classe HybridBoxSearch de services/box_search_strategies.py](../Images/code/HybridBoxSearch_f_search.png)
...
![Fonction flush_batch de la classe SearchResultsPanel de views/components/sam3_dialog.py](../Images/code/SearchResultsPanel_f_flush_batch.png)
